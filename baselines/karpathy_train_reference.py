"""
ALREADY DONE (reference copy).

This file is a frozen copy of `train.py` so the project can be organized into
phases without asking you to redo the Karpathy walkthrough work.

Do not edit this unless you are intentionally changing the baseline.
"""

# NOTE: Intentionally copied verbatim from `train.py` at time of scaffolding.
# If you later modify `train.py`, keep this file as a historical reference.
